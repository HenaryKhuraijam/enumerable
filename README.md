...
This repository includes files for linting and `my_list.rb` `enumerable.rb` which holds the morse code logic.
...
**[Enumerable]** is a database project built using `ruby` to Understant how to use module inside class in ruby.
...
```sh
  cd my-folder
  git clone https://github.com/HenaryKhuraijam/enumerable.git
```
...
Feel free to check the [issues page](https://github.com/HenaryKhuraijam/enumerable/issues).
